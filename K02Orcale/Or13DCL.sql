...
/*
[사용자계정 생성 및 권한설정]
해당 내용은 DBA권한이 있는 최고관리자(sys, system)로 접속한후
...
alter user test_user1 quota 2m on system;/*
            test_user1이 system 테이블스페이스에 테이블을 생성할수 있도록
            2m의 용량을 할당한다. 
        */


--2번째 사용자 추가 : 테이블스페이스 users를 사용할수 있도록 생성한다.
...
--테이블 생성시도2 => no privileges on tablespace 'USERS':테이블스페이스에 권한없음
...
/*
생성된 사용자의 디폴트 테이블스페이스를 변경하고 싶은경우
