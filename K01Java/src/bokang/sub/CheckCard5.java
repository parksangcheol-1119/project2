...
public class CheckCard5 {
	...
	//     ↓ 복사 + 붙여넣기 (){}
	//인자생성자
	public CheckCard5(long cardNumber, String owner, int balace, int point) {
	...
	public CheckCard5(long cardNumber, String owner, int balace) {
		super();
		this.cardNumber = cardNumber;
		this.owner = owner;
		this.balace = balace;
	...
	public CheckCard5(long cardNumber, String owner) {
		super();
		this.cardNumber = cardNumber;
		this.owner = owner;
		this.balace = 0;
