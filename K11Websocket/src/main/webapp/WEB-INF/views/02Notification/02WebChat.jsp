...
window.onload = function(){		
	...
	webSocket = new WebSocket('ws://localhost:8081/k11websocket/EchoServer.do');
	/*
	만약 웹브라우저가 웹소켓을 지원하지 않는다면 객체를 생성할 수 없으므로
	채팅을 사용할수 없다. JS를 통해서 객체를 생성하고 있다. 
	*/
...
//상대방이 보낸 메세지를 UI를 적용하여 출력하기 위한 부분
...
//대화내용을 입력한 후 Enter키를 통해 메세지를 전송할수 있다.
function enterkey() {	
	//엔터키를 눌렀을때만 해당 함수를 호출한다. 
