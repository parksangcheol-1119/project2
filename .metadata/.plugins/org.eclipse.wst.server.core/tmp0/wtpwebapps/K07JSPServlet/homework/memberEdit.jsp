...
String tel01=telArr[0];
String tel02=telArr[1];
String tel03=telArr[2];
    ...
    <div class="wrap_regiform">
        ...
        <table class="regi_table">
            ...
            <tr>
                <td></td>
                <td>
                    <input type="text" class="w04" name="address1" value="<%=dto.getAddress1() %>" />                
                    <input type="text" class="w04" name="address2" value="<%=dto.getAddress2() %>" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    -
                    <input type="text" class="w06" name="tel2" maxlength="4" value="<%=tel02 %>" onkeyup="commonFocusMove(this, 4, 'tel3');" />
                    -
                    <input type="text" class="w06" name="tel3" maxlength="4" value="<%=tel03 %>" />
                </td>
            </tr>
        </table>
