    ...
    <div class="wrap_regiform">
        ...
        <table class="regi_table">
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="w01" name="user_id" value="nakjasabal" />       
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="w01" name="pass1" value="ab1!" />                   
                </td>
            </tr>
            <tr>
                <td></td>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="w01" name="pass2" value="ab1!" />
                </td>
            </tr>
            <tr>
                <td><span class="red">*</span> 이름</td>
                <td>
                    <input type="text" class="w01" name="name" value="성낙현" />
            ...
            <tr>
                ...
                <td style="padding: 0px 0 5px 5px;">
                    <input type="text" class="w02" name="birthday" id="birthday" value="2021-11-11" />
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="w03" name="zipcode" value="12345" />
            ...
            <tr>
                <td></td>
                <td>
                    <input type="text" class="w04" name="address1" value="서울시 구로구 고척로49" />                
                    <input type="text" class="w04" name="address2" value="동부골든아파트" />
                </td>
            </tr>
            <tr>
                <td><span class="red">*</span> 이메일</td>
                <td>
                    <input type="text" class="w05" name="email1" value="nakjasabal" />
                    @
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="text" class="w06" name="mobile2" maxlength="4" 
                        value="7906" onkeyup="commonFocusMove(this, 4, 'mobile3');" />
                    -
                    <input type="text" class="w06" name="mobile3" maxlength="4" 
                        value="3600" onkeyup="commonFocusMove(this, 4, 'tel1');" />
                </td>
            </tr>
            <tr>
                <td>전화번호</td>
                <td>
                    ...
                    -
                    <input type="text" class="w06" name="tel2" maxlength="4" value="1234" onkeyup="commonFocusMove(this, 4, 'tel3');" />
                    -
                    <input type="text" class="w06" name="tel3" maxlength="4" value="5678" />
                </td>
            </tr>
        </table>
